...
Group #3 და Group #4-ის ცვლადები Railway-ზე უნდა იყოს დაყენებული.
...
### სავალდებულო ცვლადები Group #3-ისთვის (მაისის ჯგუფი #1):
...
### სავალდებულო ცვლადები Group #4-ისთვის (მაისის ჯგუფი #2):
...
რამდენიმე კვირის წინ აღმოვაჩინეთ, რომ Group #3-ის Drive folder ID
...
2. შემოწმე რომ ხედავ:
   - `AI კურსი (მაისის ჯგუფი #1. 2026)` — Group #3
   - `AI კურსი (მაისის ჯგუფი #2. 2026)` — Group #4
...
- `analytics.py` სრულად დინამიკურია — Group #3 + Group #4 ხილვადია
  dashboard-ში
...
- ცხელი ლექციის dashboard label-ები ცოცხალია G3/G4-ისთვის
...
- [ ] 18:00-ზე Group #4-ის pre-meeting reminder ავტომატურად გავა
      (n8n workflow-ი)
