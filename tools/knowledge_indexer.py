...
Indexes lecture transcripts, summaries, and gap analyses into a Pinecone
vector database so the WhatsApp assistant can retrieve relevant course knowledge.

Embedding model: gemini-embedding-001 (Google) — dimension=3072.
"""
