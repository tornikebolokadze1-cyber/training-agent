    ...
    def _decide_and_reason(
        ...
        trigger_instruction = (
            ...
            if is_direct
                ...
                "This message was NOT a direct mention. You are a quiet observer in this "
                "AI literacy course group chat. Be VERY selective about when you speak up.\n\n"
                "RESPOND only when ALL of these are true:\n"
                "- The topic is clearly about AI, technology, or the course content\n"
                "- Multiple people (2-3+) are actively discussing/debating the topic\n"
                "- You have a genuinely unique insight or perspective to add\n"
                "- Nobody has already made the point you want to make\n\n"
                "Return SILENT for:\n"
                "- Single messages, even if tech-related (wait for a discussion to form)\n"
                "- Greetings, logistics, off-topic chat\n"
                "- Simple reactions or short comments\n"
                "- When someone already covered what you would say\n\n"
                "When in doubt, SILENT. You are modest and speak rarely but meaningfully."
            )
        )
